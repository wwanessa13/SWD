...
```{r}
(g11 <- ggplot(mtcars, aes(x = hp, y = mpg, color = factor(cyl))) +
  geom_point(size = 3, alpha = 0.7) +
  labs(title = " ", x = "Potência", 
       y = "Consumo", color = "Cilindros") +
  theme_classic())

(g22 <- ggplot(mtcars, aes(x = hp, y = mpg, fill = factor(cyl))) +
...
g11 + 
  inset_element(g22, left = 0.3, bottom = 0.4, right  = 0.95, top = 1)
```
